...
)
{
    ...
    PREFIX( fft_setup_set_config_base )( fft_type, 0, log2m, log2n, opt_flag, p_setup, r_info );
    SAL_RINFO_CHECK_CODE_INT(r_info);

    PREFIX( fft_setup_create_csal )( p_setup, opt_flag, r_info );
