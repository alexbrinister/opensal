...
#include "adapters.h"
#include "cmat_auto_mulx_aux_csal.h"
...

{
    ...
    switch ( flag & SAL__MASK_TRANSPOSE )
    {
        case( SAL_TRANSPOSE_LEFT | SAL_TRANSPOSE_RIGHT ) :
            rc = PREFIX( cmat_auto_mulx_atat )( pA,
                                                Atcols,
                                                pC,
                                                Ctcols,
                                                n_c,
        ...
        case SAL_TRANSPOSE_LEFT :
            rc = PREFIX( cmat_auto_mulx_ata )( pA,
                                               Atcols,
                                               pC,
                                               Ctcols,
                                               n_c,
        ...
        case SAL_TRANSPOSE_RIGHT :
            rc = PREFIX( cmat_auto_mulx_aat )( pA,
                                               Atcols,
                                               pC,
                                               Ctcols,
                                               n_c,
            ...
            break;
        default :
            rc = PREFIX( cmat_auto_mulx_aa )( pA,
                                              Atcols,
                                              pC,
                                              Ctcols,
                                              n_c,
