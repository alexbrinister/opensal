...
#include "adapters.h"
#include "mat_auto_muldx_aux_csal.h"
...

{
    ...
    switch ( flag & SAL__MASK_TRANSPOSE )
    {
        case( SAL_TRANSPOSE_LEFT | SAL_TRANSPOSE_RIGHT ) :
            rc = PREFIX( mat_auto_muldx_atat )( pA,
                                                Atcols,
                                                pC,
                                                Ctcols,
                                                n_c,
        ...
        case SAL_TRANSPOSE_LEFT :
            rc = PREFIX( mat_auto_muldx_ata )( pA,
                                               Atcols,
                                               pC,
                                               Ctcols,
                                               n_c,
        ...
        case SAL_TRANSPOSE_RIGHT :
            rc = PREFIX( mat_auto_muldx_aat )( pA,
                                               Atcols,
                                               pC,
                                               Ctcols,
                                               n_c,
            ...
            break;
        default :
            rc = PREFIX( mat_auto_muldx_aa )( pA,
                                              Atcols,
                                              pC,
                                              Ctcols,
                                              n_c,
