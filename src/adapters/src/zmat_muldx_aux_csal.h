...
----------------------------------------------------------------------------
    ...
    Filename:
        zmat_muldx_aux_csal.h

----------------------------------------------------------------------------
*/

#ifndef ZMAT_MULDX_AUX_CSAL_H
#define ZMAT_MULDX_AUX_CSAL_H
...
#include <csal_internal.h>
    ...
    static SAL_i32 PREFIX( zmat_muld_nn ) ( SAL_zf64 *pA,
    SAL_i32 Atcols,
    SAL_zf64 *pB,
    SAL_i32 Btcols,
    SAL_zf64 *pC,
    ...
    static SAL_i32 PREFIX( zmat_muld_tn ) ( SAL_zf64 *pAt,
                                            SAL_i32 Atcols,
                                            SAL_zf64 *pB,
                                            SAL_i32 Btcols,
                                            SAL_zf64 *pC,
    ...
    static SAL_i32 PREFIX( zmat_muld_nt ) ( SAL_zf64 *pA,
                                            SAL_i32 Atcols,
                                            SAL_zf64 *pBt,
                                            SAL_i32 Btcols,
                                            SAL_zf64 *pC,
    ...
    static SAL_i32 PREFIX( zmat_muld_tt ) ( SAL_zf64 *pAt,
                                            SAL_i32 Atcols,
                                            SAL_zf64 *pBt,
                                            SAL_i32 Btcols,
                                            SAL_zf64 *pC,
