...
----------------------------------------------------------------------------
    ...
    Filename:
        cmat_mulx_aux_csal.h

----------------------------------------------------------------------------
*/

#ifndef CMAT_MULX_AUX_CSAL_H
#define CMAT_MULX_AUX_CSAL_H
...
#include <csal_internal.h>
    ...
    static SAL_i32 PREFIX( cmat_mul_nn ) ( SAL_cf32 *pA,
    SAL_i32 Atcols,
    SAL_cf32 *pB,
    SAL_i32 Btcols,
    SAL_cf32 *pC,
    ...
    static SAL_i32 PREFIX( cmat_mul_tn ) ( SAL_cf32 *pAt,
                                           SAL_i32 Atcols,
                                           SAL_cf32 *pB,
                                           SAL_i32 Btcols,
                                           SAL_cf32 *pC,
    ...
    static SAL_i32 PREFIX( cmat_mul_nt ) ( SAL_cf32 *pA,
                                           SAL_i32 Atcols,
                                           SAL_cf32 *pBt,
                                           SAL_i32 Btcols,
                                           SAL_cf32 *pC,
    ...
    static SAL_i32 PREFIX( cmat_mul_tt ) ( SAL_cf32 *pAt,
                                           SAL_i32 Atcols,
                                           SAL_cf32 *pBt,
                                           SAL_i32 Btcols,
                                           SAL_cf32 *pC,
