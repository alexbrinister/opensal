...
)
{
    ...
    for ( i = 0; i < ONR; i++ )
    {
        ...
        for ( j = 0; j < ONC; j++ )
        {
            ...
            if ( step_flag == DP_STEP )
            {
                xstep = xstep + ( SAL_f64 )xcinc;
                ystep = ystep + ( SAL_f64 )ycinc;
            }
            else
            {
                xstep_sp = xstep_sp + xcinc;
                ystep_sp = ystep_sp + ycinc;
            }
        }
