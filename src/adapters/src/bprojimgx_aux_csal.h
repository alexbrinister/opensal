...
----------------------------------------------------------------------------
    ...
    Filename:
        bprojimgx_aux_csal.h

----------------------------------------------------------------------------
*/

#ifndef BPROJIMGX_AUX_CSAL_H
#define BPROJIMGX_AUX_CSAL_H
...
#include "csal_internal.h"
    ...
    {
        SAL_i32    i, remain;
        SAL_f32  finc1, finc2, finc3, finc4, finc5, finc6;
        SAL_f32  findex0, findex1, findex2, findex3, findex4, findex5;
